...
router.post('/', (0, cursosController_1.validar)(), cursosController_1.insertar);
...
router.put('/:id', (0, cursosController_1.validar)(), cursosController_1.modificar);
router.delete('/:id', cursosController_1.eliminar);
